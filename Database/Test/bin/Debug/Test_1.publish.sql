...
GO
PRINT N'正在创建 [Test_FileGroup]...';


GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILEGROUP [Test_FileGroup];


GO
PRINT N'正在创建 [Test_FileGroup_File]...';


GO
ALTER DATABASE [$(DatabaseName)]
    ADD FILE (NAME = [Test_FileGroup_File], FILENAME = '$(DefaultDataPath)$(DefaultFilePrefix)_Test_FileGroup_File.ndf', SIZE = 10 MB, FILEGROWTH = 10 %) TO FILEGROUP [Test_FileGroup];
